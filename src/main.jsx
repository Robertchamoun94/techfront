  ...
  const services = [
    {
      ...
      title: "Månads prenumeration",
      price: "299kr",
      period: "/månaden",
      stripeUrl: "https://buy.stripe.com/aFa6oH3Cy94kaApdwT67S03",
      features: [
        "Full support",
        "Hjälp med underhåll & uppdatering",
        "Koppla domän till hemsida & Go Online",
        "SEO Optimeringar",
      ],
    ...
    },
    {
      ...
      features: [
        "Kunden äger alla rättigheter & ansvar över sidan",
        "Ingen support",
        "Kunden ansvarar själv för att koppla domän och gå online",
      ],
